...
//                     <div className="defiOverview">
//                         <span className="defiOverviewContent">
//                         Belt.fi is an AMM protocol that incorporates multi-strategy yield optimizing on Binance Smart Chain (BSC) with low fees/slippage that also provides aggregation through vault compounding, lending and yield generation for maximum returns. <br />
//                         <a href="https://docs.belt.fi/security-and-risks" target="_blank">https://docs.belt.fi/security-and-risks</a>
//                         </span>
//                     </div>
//                 );
//                 break;  
...
//                     <div className="defiOverview">
//                         <span className="defiOverviewContent">
//                         BiFi (abbreviation of Bifrost Finance) is the decentralized finance platform built on Bifrost, the universal multichain middleware. BiFi aims to create a multichain DeFi ecosystem for  cryptocurrencies with financial products and services that interoperate across multiple blockchains with scalable efficiency.<br />
//                         BiFi Lending Audit: <a href="https://github.com/bifrost-platform/BIFI/blob/master/docs/bifrost_bifi_audit.pdf" target="_blank">https://github.com/bifrost-platform/BIFI/blob/master/docs/bifrost_bifi_audit.pdf</a>
//                         </span>
//                     </div>
//                 );
//             break;        
